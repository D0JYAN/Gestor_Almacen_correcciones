...
async function cargarDatos() {
    try {
        const response = await fetch('https://gestor-almacen-syatec.onrender.com/extraer/visualizar');
...
document.addEventListener("DOMContentLoaded", async function () {
    ...
    if (form) {
        form.addEventListener("submit", async function (event) {
            ...
            try {
                const response = await fetch("https://gestor-almacen-syatec.onrender.com/extraer/agregar", {
                    method: "POST",
...
document.addEventListener("DOMContentLoaded", async function () {
    ...
    document.getElementById('formEditarSalida').addEventListener('submit', async function (event) {
        ...
        try {
            const response = await fetch(`https://gestor-almacen-syatec.onrender.com/extraer/actualizar/${editarData.id}`, {
                method: 'PUT',
                headers: {
...
async function eliminar(id) {
    ...
    try {
        const response = await fetch(`https://gestor-almacen-syatec.onrender.com/extraer/eliminar/${id}`, {
            method: 'DELETE'
        });
        if (response.ok) {
