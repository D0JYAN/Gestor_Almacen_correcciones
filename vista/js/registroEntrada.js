...
async function cargarDatos() {
    try {
        const response = await fetch('https://gestor-almacen-syatec.onrender.com/ingresar/mostrar');
...
document.addEventListener("DOMContentLoaded", async function () {
    ...
    if (form) {
        form.addEventListener("submit", async function (event) {
            ...
            try {
                const response = await fetch("https://gestor-almacen-syatec.onrender.com/ingresar/ingresar", {
                    method: "POST",
...
async function cargarMateriales() {
    ...
    try {
        const response = await fetch("https://gestor-almacen-syatec.onrender.com/principal/principal");
        const data = await response.json();
...
async function cargarTrabajadores() {
    ...
    try {
        const response = await fetch("https://gestor-almacen-syatec.onrender.com/trabajador/visualizar");
        const data = await response.json();
...
document.addEventListener("DOMContentLoaded", async function () {
    ...
    document.getElementById('formEditarEntrada').addEventListener('submit', async function (event) {
        ...
        try {
            const response = await fetch(`https://gestor-almacen-syatec.onrender.com/ingresar/actualizar/${editarData.id}`, {
                method: 'PUT',
                headers: {
...
async function eliminar(id) {
    ...
    try {
        const response = await fetch(`https://gestor-almacen-syatec.onrender.com/ingresar/eliminar/${id}`, {
            method: 'DELETE'
        })
        if (response.ok) {
